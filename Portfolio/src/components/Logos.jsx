...
export default function Logos({mode}) {
useEffect(()=>{
  const tl=gsap.timeline()
  tl.to('#logo',{ opacity: 0, scale: 0.5 })
  tl.to('#logo',{opacity:1,scale:1,duration:0.3,ease:"back.in"})
  tl.to('#logo',{opacity:1,scale:1,x:200,duration:0.5,ease:"power1.in"})
  tl.to('#logo',{opacity:1,scale:1.2,x:100,duration:0.2,ease:"power3.in"},"<1")
  tl.to('#logo',{opacity:1,scale:1,x:0,duration:0.1,ease:"power3.in"})
  ...
  return (
    ...
    >
      ...
      <path id='logo'
        ...
        fill={mode === "dark" ? "white" : "black"}
      />
      <path id='logo'  d="M95.7004 15V0.600006H98.5604V15H95.7004Z" fill={mode === "dark" ? "white" : "black"} />
      <path id='logo'
        ...
        fill={mode === "dark" ? "white" : "black"}
      />
      <path id='logo' d="M68.884 15V0.600006H71.744V15H68.884Z" fill={mode === "dark" ? "white" : "black"}/>
      <path id='logo'
